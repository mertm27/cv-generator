...
const ModernTheme: React.FC<ModernThemeProps> = ({ cvData }) => {
    ...
    <div className="bg-white shadow-lg rounded-lg overflow-hidden" style={{ maxWidth: '210mm', minHeight: '297mm' }}>
      ...
      <div className="bg-gradient-to-r from-blue-600 to-blue-800 text-white p-8">
        <div className="flex items-center space-x-6">
          ...
          <div className="flex-1">
            ...
            <p className="text-xl text-blue-100 mb-4">{cvData.jobTitle || 'Your Job Title'}</p>
      ...
      <div className="flex">
        ...
        <div className="w-1/3 bg-gray-50 p-6">
          ...
          {cvData.summary && (
            <div className="mb-8">
              <h2 className="text-lg font-semibold text-gray-800 mb-3 border-b-2 border-blue-500 pb-1">
                Summary
              </h2>
          ...
          {cvData.skills.length > 0 && (
            <div className="mb-8">
              <h2 className="text-lg font-semibold text-gray-800 mb-4 border-b-2 border-blue-500 pb-1">
                Skills
              </h2>
                ...
                {cvData.education.map((edu) => (
                  <div key={edu.id} className="border-l-4 border-blue-500 pl-4">
                    <div className="mb-2">
                      ...
                      <p className="text-sm font-medium text-blue-600">{edu.school}</p>
                      <div className="flex items-center text-xs text-gray-500 mt-1">
