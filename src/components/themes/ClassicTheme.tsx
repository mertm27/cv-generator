...
const ClassicTheme: React.FC<ClassicThemeProps> = ({ cvData }) => {
    ...
    <div className="bg-white shadow-lg rounded-lg overflow-hidden" style={{ maxWidth: '210mm', minHeight: '297mm' }}>
      ...
      <div className="bg-gray-900 text-white p-8">
        <div className="flex items-center space-x-6">
          ...
          <div className="flex-1">
            ...
            <p className="text-xl text-gray-300 mb-4">{cvData.jobTitle || 'Your Job Title'}</p>
      ...
      <div className="flex">
        ...
        <div className="w-1/3 bg-gray-100 p-6">
          ...
          {cvData.summary && (
            <div className="mb-8">
              <h2 className="text-lg font-semibold text-gray-800 mb-3 border-b-2 border-gray-800 pb-1">
                Summary
              </h2>
          ...
          {cvData.skills.length > 0 && (
            <div className="mb-8">
              <h2 className="text-lg font-semibold text-gray-800 mb-4 border-b-2 border-gray-800 pb-1">
                Skills
              </h2>
